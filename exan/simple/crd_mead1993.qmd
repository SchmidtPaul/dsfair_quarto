...
We make use of `dlookr::describe()`[^99] to conveniently obtain a descriptive summary table:

[^99]: As described in the {dlookr} section of the Summary Article "Useful things".
...
Finally, since this is an experiment that was laid with a certain experimental design (= a completely randomized design; CRD) - it makes sense to also get a field plan. This can be done via `desplot()` from [{desplot}](https://kwstat.github.io/desplot/):
...
## Model assumptions should be checked at this point
