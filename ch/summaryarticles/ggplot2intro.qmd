...
We are using [the `p_load()` function of the {pacman} package](https://schmidtpaul.github.io/dsfair_quarto/ch/summaryarticles/usefulthings.html#pacman) to install and load all necessary packages for this tutorial.
